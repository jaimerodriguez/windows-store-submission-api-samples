...
config.applicationId = config.packagedApplicationId; // quick way to reuse same config object for both packaged and unpackaged samples since the only difference is applicationId
